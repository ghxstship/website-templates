...
export const EVENTS: VEvent[] = [
  { id: "e0", title: "Nocturne Orchestra", date: "Fri 18 Sep", time: "Doors 7:00pm", cat: "Concert", from: "From $42", desc: "The full orchestra returns for a one-night program of nocturnes and film scores, performed in the round under a single moving light." },
  ...
  { id: "e3", title: "A Number — by Caryl Churchill", date: "Wed 23 Sep", time: "7:30pm", cat: "Theater", from: "From $34", desc: "A tense, intimate two-hander staged in our studio space for a strictly limited run of nine performances." },
  { id: "e4", title: "Family Prom", date: "Sat 26 Sep", time: "2:00pm", cat: "Family", from: "From $12", desc: "A relaxed, all-ages afternoon of orchestral favorites with an instrument petting zoo in the foyer beforehand." },
...
export const EVENT_CATS = ["all", "Concert", "Club", "Sports", "Theater", "Family"];
...
export const SPACES = [
  ...
  { name: "The Studio", body: "An intimate black-box space for theater, comedy and seated sessions, with flexible staging and full technical spec.", cap: "180", type: "Flexible" },
];
...
export const FAQS = [
  ...
  { q: "What is your refund policy?", a: "Tickets are refundable if an event is canceled or rescheduled. Otherwise they can be resold through our official fan-to-fan exchange." },
];
