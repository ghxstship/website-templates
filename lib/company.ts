...
export const PRODUCTS = [
  { mark: "C", name: "Core", body: "The unified data layer — connectors, modeling and a query surface the whole team shares.", detail: "Core ingests from every system you run, reconciles it into one governed model, and exposes it through a query surface anyone can use — in SQL or plain language. Row-level permissions, full lineage and point-in-time history come standard, so the number on the dashboard is always one you can defend." },
