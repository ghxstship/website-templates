...
export const MEDIA: Media[] = [
  ...
  { id: "m2", title: "Harbour, 4am", creator: "Field Notes", type: "image", meta: "Photo set · 24", locked: true, num: 8, ratio: "4/5" },
...
export const PLANS = [
  ...
  { key: "pro", name: "Studio", tagline: "For pros", price: "$25", per: "/mo", perks: ["Everything in Premium", "Commercial licence", "Bulk file downloads", "API access"], prem: true, featured: false },
];
