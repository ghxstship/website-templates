...
export const FIELD_SETS: Record<Mode, { cols: string; fields: Field[] }> = {
  flights: { cols: "1fr 1fr 1fr 1fr auto", fields: [ { label: "From", type: "text", value: "London (LHR)", ph: "City or airport" }, { label: "To", type: "text", value: "", ph: "City or airport" }, { label: "Depart", type: "date", value: "2026-09-18", ph: "" }, { label: "Travelers", type: "text", value: "1 adult", ph: "" } ] },
