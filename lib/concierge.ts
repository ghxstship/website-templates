...
export const SERVICE_SECTIONS = [
  { name: "Dining & nightlife", cat: "Dining", intro: "From the neighborhood favorite to the three-month waitlist — and the quiet corner table you actually wanted.", items: ["Reservations", "Private dining", "Sommelier picks", "Guest lists"] },
  { name: "Travel", cat: "Travel", intro: "Whole trips or a single transfer, planned and re-planned as life changes. We hold the details so you don’t.", items: ["Flights & upgrades", "Hotels & villas", "Transfers", "Itineraries", "Visas"] },
  { name: "Access & events", cat: "Events", intro: "Tickets and access for the things that sell out in seconds, plus the invitations money can’t normally buy.", items: ["Premieres", "Sport & courtside", "Fashion week", "Private previews"] },
  { name: "Home & lifestyle", cat: "Home", intro: "The running of a life — vetted people, on time, checked in on. Gifts sourced and errands cleared.", items: ["Household staff", "Deliveries", "Gifting", "Personal shopping", "Wellness"] },
];
