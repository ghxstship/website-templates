  ...
  return (
    <>
      ...
      <section className="wrap" style={{ paddingBlock: "8px 0" }}>
        <button type="button" onClick={() => setShowSaved((v) => !v)} className={showSaved ? "btn btn-primary" : "btn btn-secondary"} style={{ padding: "8px 16px" }}>{showSaved ? `Showing saved · ${fav.count}` : `Saved · ${fav.count}`}</button>
      </section>
